...
import fr.traqueur.endiapower.api.commands.exceptions.NoOptionalArgsWithInfiniteArgumentException;
...
/**
 * Cette classe abstraite représente une commande du plugin Sphaleria.
 * Elle permet de créer et gérer des commandes avec leurs sous-commandes, des arguments et des permissions.
 *
 */
public abstract class EndiaCommand {

    // Attributs de la classe

    /**
     * Le plugin Sphaleria auquel appartient la commande.
     */
     ...
     */
    private final ArrayList<EndiaCommand> subcommands;
    ...
    /**
     * Constructeur de la classe SphaleriaCommand.
     *
     * @param plugin Le plugin Sphaleria auquel appartient la commande.
     * @param name   Le nom de la commande.
     */
    public <T extends JavaPlugin> EndiaCommand(T plugin, String name) {
        this.plugin = plugin;
        this.name = name;
        this.permission = "";
        this.usage = "";
     ...
     */
    public ArrayList<EndiaCommand> getSubcommands() {
        return subcommands;
    }
     ...
     */
    public void addSubCommand(EndiaCommand... commands) {
     ...
     */
    public void addSubCommand(EndiaCommand command) {
